...
# Helper function to display matrix info
...
if uploaded_file is not None:
    ...
    try:
        # Load the image using Pillow and convert to matrix
        ...
        with col1:
            ...
            # Display the actual image using Pillow
            ...
            st.write({extract_channel})
            
            # Show a small preview of pixel values
